 ...
 */
public class CustomAutoCompleteText extends AutoCompleteTextView implements TextWatcher {
        ...
        public CustomAutoCompleteText(Context context, AttributeSet attrs, int defStyle) {
